    ...
    
    {
        ...
        value:function(){
          for(var t=this.body.nodes,e=this.physicsBody.physicsNodeIndices,i=this.physicsBody.forces,n=this.options.nodeDistance,o=0;o<e.length-1;o++){
            var group1 = t[e[o]].options.group;
            for(var r=t[e[o]],s=o+1;s<e.length;s++){
              var a=t[e[s]];
              var group2 = a.options.group;
      
              // console.log(group1, group2)
              if(r.level===a.level && group1 == group2)
              {
                var h=n+this.overlapAvoidanceFactor*((r.shape.radius||0)/2+(a.shape.radius||0)/2),l=a.x-r.x,d=a.y-r.y,c=Math.sqrt(l*l+d*d),u=void 0;
